package me.wilux.blockshelf_playground.commands;

import me.wilux.blockshelf_playground.BlockshelfPlayground;
import me.wilux.blockshelf_playground.Register.FakeRecipe;
...
public class DebugCommand2 implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        NamespacedKey bukkitRecipeKey = new NamespacedKey(BlockshelfPlayground.plugin, "indexer.stone");
